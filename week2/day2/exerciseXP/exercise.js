...
function changeEnough(itemPrice, amountOfChange) {
    const totoalMoney = amountOfChange[0] * 0.25 + amountOfChange[1] * 0.10 + amountOfChange[2] * 0.05 + amountOfChange [3] * 0.01;
    return totoalMoney >= itemPrice;
}
...
function hotelCost() {
    let nights 
    do {
        nights = Number(prompt("How many night would you like to stay in the hotel? "));
...
function rentalCarCost() {
    ...
    // Apply discount if more than 10 days
    if (days > 10) {
...
//please refer to index.html and script.js
