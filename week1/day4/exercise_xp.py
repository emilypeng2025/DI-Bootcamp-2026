...
def display_message():
    print("I didn't learn well about functions in Python last year.")
...
def favorite_book(title):
    print(f"I want to share with you my favorite book {title}.")
...
def show_magicians(magician_names):
    for magician in magician_names:
        print(f"Now let's welcome {magician}!")

def make_great(magician_names):
    the_great = []
    for magician in magician_names:
        the_great.append(f"{magician} the Great")
    return the_great

great_magicians = make_great(magician_names)
show_magicians(great_magicians)

#a more clear version with different names for parameter and variable so it is less confusing:
...
#     great_list = []
#     for magician in names:
#         great_list.append(f"{magician} the Great")
#     return great_list
...
def main():
    ...
    if temp < 0:
        ...
        print("Nice weather! Enjoy outdoor activities.")
    elif 24 <= temp < 32:
